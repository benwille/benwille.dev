...
export const experience: ExperienceItem[] = [
	{
		...
		dates: '2025 – Present',
		bullets: [
			'Designed and prioritized NPS-driven initiatives addressing feature and education gaps, improving guest satisfaction scores.',
			'Mapped and optimized workflows for direct, connection, and IROP journeys to reduce friction and increase self-service success.',
			'Partnered with Ops, CX, Marketing, and Data Science to deliver features with measurable operational and revenue impact.',
			'Led strategic improvements to check-in, boarding, and disruption communications to enhance the day-of-travel experience.',
		],
